...
Живое демо (со статичными примерами, без реальной БД): **https://windowrepino.ru/notimeoutcsv/index.html**

## Скриншоты

| Список отчётов | Параметры запуска |
|---|---|
| ![Список отчётов](assets/reports_list.jpg) | ![Параметры запуска](assets/params_form.jpg) |

| История выгрузок | Конструктор отчёта |
|---|---|
| ![История выгрузок](assets/history.jpg) | ![Конструктор отчёта](assets/settings.jpg) |
